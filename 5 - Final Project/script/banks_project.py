...
csv_path = f'5 - Final Project/output/{csv_name}'
db_path = f'5 - Final Project/database/{db_name}'

log_file = "code_log.txt"
log_path = f"5 - Final Project/log/{log_file}"
...
def transform(df, new_columns):
    ...
    # Read exchange rates
    exchange_rates = pd.read_csv('5 - Final Project/data/exchange_rate.csv')
